...
{
	// preparing start packets of threads abd docs
	...
	// start packets of threads for loading docs и freq_dictionary's keys
	...
	// loading freq_dictionary's value - ABS_rank of key_words
	Entry entry;
...
std::vector<Entry> InvertedIndex::GetWordCount(const std::string& word)
{
	...
	// если ABS rank слово-ключa 0 - пустой вектор
